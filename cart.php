...
?>
        					...
        					<div class="col-md-12 table-responsive">
								...
								<tbody>
                                	...
                                	<?php 
										...
										$xid = str_replace(' ', 'a', $strengthsize);
										$id = $cart_item[0] . $xid;
										...
										<td>
											<div class="custom-quantity-input">
												<input type="text" id="quantity'. $id.'" name="quantity'. $id .'" value="'. $cart_item[1] .'">
												<a href="javascript:void(0)" onclick="document.getElementById(\'quantity'. $id .'\').value = parseInt(document.getElementById(\'quantity'. $id .'\').value, 10) + 1" class="quantity-btn quantity-input-up"><i class="fa fa-angle-up"></i></a>
												<a href="javascript:void(0)" onclick="if(document.getElementById(\'quantity'. $id .'\').value != 0) document.getElementById(\'quantity'. $id .'\').value = parseInt(document.getElementById(\'quantity'. $id.'\').value, 10) - 1" class="quantity-btn quantity-input-down"><i class="fa fa-angle-down"></i></a>
											</div>
										</td>
	...
	<option value="WY">Wyoming</option>
                                                ...
                                                <div class="sm-margin"></div>
                                                <div class="form-group">
                                                    <label for="select-service" class="control-label"  >Shipping Service&#42;</label>
													<div class="input-container">
                                                        <select name="select-service" id="select-service" type="text" class="form-control" placeholder="40503">
                                                        	<option value="PRIORITY" selected="selected">Priority Mail</option>
                                                            <option value="PRIORITY MAIL EXPRESS">Priority Express Mail</option>
                                                            <?php
																$weight = explode(';', $cart->getCartWeight());
																$weightlbs = $weight[0];
																$weightoz = $weight[1];
																if($weightlbs == 0 && $weightoz <= 13) {
																	echo('<option value="FIRST CLASS">First Class Mail</option>');	
																}
															?>
                                                        </select>
                                                    </div>
