        				...
        				<div class="row">
        					...
        					<div class="col-md-9 col-sm-8 col-xs-12 main-content">
        						<header class="content-title">
									...
									<p class="title-desc">All our e-liquids are mixed in-house, using an 80/20 VG:PG blend for the best flavor and vapor<br /> production. We guarantee you'll find a new favorite in our selection.</p>
								</header>
                                ...
                                <?php 
								$result = db_query("SELECT * FROM items WHERE category='liquid' ORDER BY id");
								$rname = "";
								$ccount = 0;
								$tcount = 0;
								$table = array();
