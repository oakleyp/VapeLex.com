...
ob_end_flush();
page_begin("Accessories", "We only stock top of the line parts for our selection of accesories and replacements. Whether you're upgrading a build or starting from scratch, we've got you covered with the lowest prices in town.");
?>
        				...
        				<div class="row">
        					...
        					<div class="col-md-9 col-sm-8 col-xs-12 main-content">
        						<header class="content-title">
									...
									<p class="title-desc">We only stock top of the line parts for our selection of accesories and replacements. Whether you're upgrading a build or starting from scratch, we've got you covered with the lowest prices in town.</p>
								</header>
                                ...
                                <div align="right" style="margin-right:20px">
										...
										<ul class="pagination">
											...
											$result = db_query("SELECT * FROM items WHERE category='accessories' ORDER BY id LIMIT $start_from, $view");
											//Pagination
					
											$q = db_query("SELECT COUNT(name) FROM items WHERE category='accessories'");  
											$row = mysql_fetch_row($q); 
											$total_records = $row[0]; 
											$total_pages = ceil($total_records / $view); 
											for ($i=1; $i<=$total_pages; $i++) { 
												if($i == $page) {
            										echo "<li class=\"active\"><a href='accessories.php?page=".$i."'>".$i."</a></li>";
												} else {
													echo "<li><a href='accessories.php?page=".$i."'>".$i."</a></li>";	
												}
											}; 
											if($page < $total_pages) {
													echo("<li><a href=\"accessories.php?page=".($page+1)."\"><i class=\"fa fa-angle-right\"></i></a></li>");
											}
								...
								?>
                                    ...
                                    <?php 
									$result2 = db_query("SELECT * FROM items WHERE category='accessories' ORDER BY id DESC LIMIT 9");
										$rname = "";
								$ccount = 0;
								$tcount = 0;
								$table = array();
								...
								foreach ($table as $product) {
                                    ...
                                    <?php
										/*$topq = db_query("SELECT * FROM items WHERE category='accessories'");
										$ccount = 0;
										$tcount = 0;
										$table = array();
										$trow = array();
