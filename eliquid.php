...
ob_end_flush();
page_begin("E-Liquid", "All of our e-liquids are hand-crafted in the US, using an 80/20 VG:PG blend for the best taste and vapor production. No need to take our word for it, though: Open an account with us, and you're welcome to a free 5mL sample of any flavor, every month.");
?>
        				...
        				<div class="row">
        					...
        					<div class="col-md-9 col-sm-8 col-xs-12 main-content">
        						<header class="content-title">
									...
									<p class="title-desc">All of our e-liquids are hand-crafted in the US, using an 80/20 VG:PG blend for the best taste and vapor production. No need to take our word for it, though: Open an account with us, and you're welcome to a free 5mL sample of any flavor, every month. </p>
								</header>
        									...
        									<div class="item-meta-container">
        										...
        										<div class="item-action">
        											...
        											<div class="item-action-inner">
        												...
        												<a href="product.php?id='.$product['pid'].'" class="icon-button icon-compare">Add to Cart</a>
								...
								?>
                                    ...
                                    <?php 
									$result2 = db_query("SELECT * FROM items WHERE category='liquid' ORDER BY id DESC LIMIT 9");
										$rname = "";
								$ccount = 0;
								$tcount = 0;
								$table = array();
